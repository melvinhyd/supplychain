...
contract SupplyChain is Ownable, ConsumerRole, DistributorRole, FarmerRole, RetailerRole{
  ...
  function buyItem(uint _upc) public payable 
    ...
    address buyr = msg.sender;
    uint price = items[_upc].productPrice;
    items[_upc].ownerID = buyr;
    items[_upc].distributorID = buyr;
  ...
  function receiveItem(uint _upc) public 
    ...
    address retailID = msg.sender;
    items[_upc].ownerID = retailID;
    items[_upc].retailerID = retailID;
  ...
  function purchaseItem(uint _upc) public 
    ...
    items[_upc].retailerID = consumerID;
